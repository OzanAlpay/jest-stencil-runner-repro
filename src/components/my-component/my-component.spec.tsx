...
<my-component first="Stencil" middle="'Don't call me a framework'" last="JS">
  <template shadowrootmode="open">
    <div>
      Hello, World! I'm Stencil 'Don't call me a framework' JS, viewport width is 1366
    </div>
  </template>
</my-component>
`);
...
`);
  ...
  describe('Text Matchers', () => {
    it('should display correct text content', async () => {
      ...
      expect(div).toEqualText("Hello, World! I'm Alice Marie Johnson, viewport width is 1366");
    });
    ...
    it('should handle empty names', async () => {
      ...
      const div = root.shadowRoot.querySelector('div');
      expect(div).toEqualText("Hello, World! I'm , viewport width is 1366");
    });
    ...
    it('should handle single name', async () => {
      ...
      const div = root.shadowRoot.querySelector('div');
      expect(div).toEqualText("Hello, World! I'm Cher, viewport width is 1366");
    });
  });
  ...
  describe('Text Formatting Edge Cases', () => {
    it('should handle special characters in names', async () => {
      ...
      const div = root.shadowRoot.querySelector('div');
      expect(div).toEqualText("Hello, World! I'm José María García-López, viewport width is 1366");
    });
    ...
    it('should handle very long names', async () => {
      ...
      const div = root.shadowRoot.querySelector('div');
      expect(div).toEqualText(`Hello, World! I'm ${longName} Person, viewport width is 1366`);
    });
    ...
    it('should handle names with quotes', async () => {
      ...
      const div = root.shadowRoot.querySelector('div');
      expect(div).toEqualText('Hello, World! I\'m John "The Great" Smith, viewport width is 1366');
    });
  });
